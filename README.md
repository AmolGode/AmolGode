...
<p align="center">
  <img src="https://readme-typing-svg.herokuapp.com?font=Fira+Code&pause=1000&color=00F700&width=500&lines=Backend+Engineer+%7C+Django+%7C+Go+%7C+gRPC;REST+APIs+%7C+PostgreSQL+%7C+Celery+%7C+Docker;AI+Agents+%7C+Claude+Certified+Architect;800%2B+DSA+Problems+%7C+GFG+%2B+LeetCode" />
</p>
...
- Hands-on with **Celery async pipelines**, **REST API design**, **digital onboarding** (eKYC, Aadhaar e-Sign, document verification), and **large-scale data workflows**.
...
## 🛠️ Tech Stack
<p align="center">
  <img src="https://skillicons.dev/icons?i=python,django,go,postgresql,docker,redis,react,git,github,aws" />
</p>

**Languages:** Python, Go, JavaScript, SQL  
**Frameworks:** Django, Django REST Framework, Celery, React  
**Databases:** PostgreSQL, Redis, MySQL  
**Tools & AI:** Docker, gRPC, Protobuf, Prometheus, Grafana, AWS, FCM, Anthropic SDK
